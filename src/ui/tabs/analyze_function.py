# src/ui/tabs/analyze_function.py
"""
하단 액션 버튼들과 모달 기능
"""
...
from ui.styles import get_enhanced_styles  # 통합 스타일 import
from .analyze_function_recom import render_reanalysis_section  # 재추론 기능 import
...
def render_action_buttons(video):
    ...
    if st.button("🆕 새로운 영상 분석", type="secondary", use_container_width=True):
        from .analyze_tab import reset_analysis_state
