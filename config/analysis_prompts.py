...
class AnalysisPromptTemplates:
    ...
    def _load_templates(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            "Shorts/Reels": {
                "트렌드 분석": """짧은 형식 동영상(Shorts/Reels) 트렌드 분석을 요청합니다.
...
- 세로형 화면 최적화 여부
- 바이럴 요소 (챌린지, 밈, 트렌드)
- 참여 유도 요소 (CTA, 질문, 댓글 유도)
- 반복 시청 유도 요소

타겟 연령층과 플랫폼 특성을 고려한 효과성을 평가해주세요.""",

                "제품 홍보": """Shorts/Reels 제품 홍보 효과 분석을 요청합니다.
...
짧은 시간 내 구매 욕구 자극 효과를 분석해주세요.""",

                "엔터테인먼트": """Shorts/Reels 엔터테인먼트 콘텐츠 분석을 요청합니다.
