# web/components/database/video_card.py
"""
Database 탭의 비디오 카드 렌더링
"""
...
from .edit import render_editable_card_info, save_edited_data, toggle_edit_mode
from .delete import delete_manager, get_delete_button_text, get_delete_button_type
...
def render_single_video_card(video: Dict[str, Any]):
    ...
    if (st.session_state.get('show_moodboard_modal') and 
        ...
        # 무드보드를 카드 바로 아래에 렌더링
        from .moodboard import render_inline_moodboard
